// xc functional: CK16: modified Chachiyo C16 LSDA correlation functional (J. Chem. Phys. 145, 021101 (2016); https://doi.org/10.1063/1.4958669) with updated parameters from Karasiev (J. Chem. Phys. 145, 157101 (2016); https://doi.org/10.1063/1.4964758)**/
// /* #C2F-OutName: xc_ldac_ck16  */
...
void xc_ldac_ck16(double &E, double *dE, double const *D, double const Factor)
{
   ...
   double r11 = 21.7392245*r3*r4*r5*r6 + 21.7392245*r7*r8*r9*r10 + 1;
   double r12 = log(r11);
   double r13 = 0.5*r1*r12*r2;
   double r14 = 3.847322101863072;
   double r15 = 28.3559732*r3*r4*r5*r6 + 28.3559732*r7*r8*r9*r10 + 1;
   ...
   double r25 = 1.0/r6;
   double r26 = 43.478449*r24*r8*r9*r25 + 21.7392245*r22*r4*r5*r23;
   double r27 = 1.0/r11;
   double r28 = 1.0/sqr(rhoc);
   double r29 = pow(r18,(1.0/3.0));
   double r30 = pow(r19,(1.0/3.0));
   E += Factor*(rhoc*(r21 + r13));
   dE[0] += Factor*(rhoc*(0.5*r14*r16*(1.333333333333333*r28*r29*rhoo - 1.333333333333333*r28*r30*rhoo) + 0.5*r14*r20*((0.25*r1*r2*(56.7119464*r24*r8*r9*r25 + 28.3559732*r22*r4*r5*r23))/r15 - 0.5*r1*r2*r26*r27) + 0.5*r1*r2*r26*r27) + r21 + r13);
